...
let Cookies = class Cookies extends Widget {
                    ...
                    tsx("div", { class: css.default.widget_cookies_all_header },
                        tsx("div", { class: css.default.widget_cookies_all_header__div },
                            ...
                            tsx("div", { class: css.default.widget_cookies_all_header_close__div },
                                tsx("button", { id: elementIDs.cookiesMain_closeButtonID, class: this.classes(css_esri.esri_button_tertiary, css.default.widget_cookies_all_header_close__button), ariaLabel: t9n.closeButtonLabel_mainDialog, title: t9n.closeButtonLabel_mainDialog, onclick: this._main_closeButton_click.bind(this), tabindex: "0" },
                    ...
                    tsx("div", { class: css.default.widget_cookies_main_subcontent__div },
                        tsx("div", { class: css.default.widget_cookies_all_content_message__div },
                            tsx("p", null,
                                ...
                                tsx("button", { id: elementIDs.cookiesMain_manageButtonID, class: this.classes(css_esri.esri_widget_anchor, css.default.widget_cookies_all_links__button), "aria-label": t9n.manageButtonText_mainDialog, title: t9n.manageButtonText_mainDialog, onclick: this._main_manageButton_click.bind(this), tabindex: "0" }, t9n.manageButtonText_mainDialog))),
                        tsx("div", { class: css.default.widget_cookies_main_buttons__div },
                            tsx("button", { id: elementIDs.cookiesMain_acceptAllButtonID, class: this.classes(css_esri.esri_button, css.default.widget_cookies_main_buttons_accept__button), "aria-label": t9n.agreeButtonText_allDialogs, title: t9n.agreeButtonText_allDialogs, onclick: this._acceptAllButton_click.bind(this), tabindex: "0" }, t9n.agreeButtonText_allDialogs),
                            tsx("button", { id: elementIDs.cookiesMain_rejectAllButtonID, class: css_esri.esri_button, "aria-label": t9n.rejectButtonText_allDialogs, title: t9n.rejectButtonText_allDialogs, onclick: this._rejectAllButton_click.bind(this), tabindex: "0" }, t9n.rejectButtonText_allDialogs))))),
                ...
                tsx("div", { id: elementIDs.cookiesSettings_contentID, class: this.classes(css_esri.esri_widget, css.default.widget_cookies_settings_content, css.default.widget_cookies_settings_content) },
                    tsx("div", { class: css.default.widget_cookies_all_header },
                        tsx("div", { class: css.default.widget_cookies_all_header__div },
                            ...
                            tsx("div", { class: css.default.widget_cookies_all_header_close__div },
                                tsx("button", { id: elementIDs.cookiesSettings_closeButtonID, class: this.classes(css_esri.esri_button_tertiary, css.default.widget_cookies_all_header_close__button), ariaLabel: t9n.closeButtonLabel_settingsDialog, title: t9n.closeButtonLabel_settingsDialog, onclick: this._settings_closeButton_click.bind(this), tabindex: "0" },
                    ...
                    tsx("div", { class: css.default.widget_cookies_settings_buttons },
                        tsx("div", { class: css.default.widget_cookies_settings_buttons__div },
                            tsx("div", { class: css.default.widget_cookies_settings_buttons_accept__div },
                                tsx("button", { id: elementIDs.cookiesSettings_acceptAllButtonID, class: this.classes(css_esri.esri_button), "aria-label": t9n.agreeButtonText_allDialogs, title: t9n.agreeButtonText_allDialogs, onclick: this._acceptAllButton_click.bind(this), tabindex: "0" }, t9n.agreeButtonText_allDialogs)),
                            tsx("div", { class: css.default.widget_cookies_settings_buttons_reject__div },
                                tsx("button", { id: elementIDs.cookiesSettings_rejectAllButtonID, class: this.classes(css_esri.esri_button), "aria-label": t9n.rejectButtonText_allDialogs, title: t9n.rejectButtonText_allDialogs, onclick: this._rejectAllButton_click.bind(this), tabindex: "0" }, t9n.rejectButtonText_allDialogs)),
                            tsx("div", { class: css.default.widget_cookies_settings_buttons_save__div },
                                tsx("button", { id: elementIDs.cookiesSettings_saveButtonID, class: this.classes(css.default.widget_cookies_all_buttons__disabled, css_esri.esri_button, css_esri.esri_button_disabled), "aria-disabled": 'true', "aria-label": t9n.saveButtonText_allDialogs, title: t9n.saveButtonText_allDialogs, onclick: this._settings_saveButton_click.bind(this), tabindex: "0" }, t9n.saveButtonText_allDialogs))))))));
    }
    //--------------------------------------------------------------------------
    //  Private Methods
    //--------------------------------------------------------------------------
    ...
    _getPrivacyPolicyButton() {
        var privacyPolicyButton = tsx("button", { id: elementIDs.cookiesSettings_privacyPolicyButtonID, class: this.classes(css_esri.esri_widget_anchor, css.default.widget_cookies_all_links__button), "aria-label": t9n.privacyPolicyButtonText_settingsDialog, title: t9n.privacyPolicyButtonText_settingsDialog, onclick: this._settings_privacyButton_click.bind(this), tabindex: "0" }, t9n.privacyPolicyButtonText_settingsDialog);
    ...
    _getContactUsButton() {
        var contactUsButton = tsx("button", { id: elementIDs.cookiesSettings_contactUsButtonID, class: this.classes(css_esri.esri_widget_anchor, css.default.widget_cookies_all_links__button), "aria-label": t9n.contactUsButtonText_settingsDialog, title: t9n.contactUsButtonText_settingsDialog, onclick: this._settings_contactButton_click.bind(this), tabindex: "0" }, t9n.contactUsButtonText_settingsDialog);
