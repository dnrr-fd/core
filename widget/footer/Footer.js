...
let Footer = class Footer extends Widget {
    ...
    render() {
        return (tsx("div", { id: elementIDs.footerModalID, afterCreate: this.setFooter, bind: this, className: css_theme.default.widget_footer_modal },
            tsx("div", { id: elementIDs.footerID, className: this.classes(css_theme.default.widget_footer, css_theme.default.widget_footer_transition, css_esri.esri_widget, css_theme.default.widget_footer_visibility__visible) },
                tsx("div", { id: elementIDs.footer_buttonBarID, className: css_theme.default.widget_footer_button_bar },
                    tsx("div", { id: elementIDs.footer_buttonID, className: this.classes(css_theme.default.widget_footer_button, css_esri.esri_widget_button), role: "button", "aria-label": t9n.button.collapselabel, title: t9n.button.collapselabel, tabIndex: '0', onClick: this._footerButton_click.bind(this), onKeyPress: this._footerButton_keypress.bind(this) },
                        tsx("span", { id: elementIDs.footer_button_iconID, "aria-hidden": "true", className: this.classes(css_esri.esri_expand_icon_expanded, css_esri.esri_icon_expand, css_theme.default.widget_footer_transform_90_down) }),
                        tsx("span", { className: css_esri.esri_icon_font_fallback_text }, t9n.button.label))),
                tsx("div", { id: elementIDs.footer_foregroundID, className: css_theme.default.widget_footer_fg },
                    _title,
                    tsx("div", { id: elementIDs.footer_bodytextID, className: css_theme.default.widget_footer_bodytext },
                        tsx("p", null,
                            `${this.bodytext?.text ? this.bodytext.text : t9n.bodytext.text} `,
                            tsx("a", { className: this.classes(css_theme.default.widget_footer_bodytext_contact__anchor, css_theme.default.widget_footer__ignore), href: `mailto:${this.bodytext?.contactemail.emailaddress ? this.bodytext.contactemail.emailaddress : t9n.bodytext.contactemail.emailaddress}?Subject=${this.bodytext?.contactemail.subjectline ? this.bodytext.contactemail.subjectline : t9n.bodytext.contactemail.subjectline}`, title: this.bodytext?.contactemail.displayedemailtext ? this.bodytext.contactemail.displayedemailtext : t9n.bodytext.contactemail.displayedemailtext, target: '_top', tabIndex: '0' }, this.bodytext?.contactemail.displayedemailtext ? this.bodytext.contactemail.displayedemailtext : t9n.bodytext.contactemail.displayedemailtext))),
                    tsx("div", { id: elementIDs.footer_linksID, className: this.classes(css_theme.default.widget_footer_links) }, _links),
                    tsx("div", { id: elementIDs.footer_copyrightID, className: this.classes(css_theme.default.widget_footer_copyright) },
                        tsx("a", { className: this.classes(css_theme.default.widget_footer_copyright__anchor, css_theme.default.widget_footer__ignore), href: this.copyright?.link.url ? this.copyright.link.url : t9n.copyright.link.url, title: this.copyright?.link.title ? this.copyright.link.title : t9n.copyright.link.title, target: this.copyright?.link.target ? this.copyright.link.target : t9n.copyright.link.target }, this.copyright?.link.title ? this.copyright.link.title : t9n.copyright.link.title))),
                tsx("div", { className: css_theme.default.widget_footer_bg_bg1 }),
                tsx("div", { className: css_theme.default.widget_footer_bg_bg1a }),
                tsx("div", { className: css_theme.default.widget_footer_bg_bg2 }),
                tsx("div", { className: css_theme.default.widget_footer_bg_bg2a }),
                tsx("div", { className: css_theme.default.widget_footer_bg_bg3 }),
                tsx("div", { className: css_theme.default.widget_footer_bg_bg3a }),
                tsx("div", { className: css_theme.default.widget_footer_bg_bg4 }),
                tsx("div", { className: css_theme.default.widget_footer_bg_bg4a }))));
    }
    //--------------------------------------------------------------------------
    //  Private Methods
    //--------------------------------------------------------------------------
    ...
    _createReactTitle(title) {
        const _title = tsx("div", { id: elementIDs.footer_titleID, className: css_theme.default.widget_footer_title },
            tsx("p", null, title));
        return _title;
    }
    ...
    _createReactLinks(linksArray, linkLineDivClass = null, linkDivClass = null, anchorClass = null) {
        const _links = linksArray.map(links => tsx("div", { key: `${links.id}_key`, className: linkLineDivClass }, links.links.map(link => tsx("div", { key: `${link.id}_key`, className: linkDivClass },
            tsx("a", { id: link.id, className: this.classes(anchorClass, css_theme.default.widget_footer__ignore), href: link.url, target: link.target, title: link.title, tabIndex: '0' }, link.title)))));
        return _links;
    }
