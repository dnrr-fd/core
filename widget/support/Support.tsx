...
class Support extends Widget {
  ...
  postInitialize(): void {
    ...
    reactiveUtils.watch(() => self.visible, (visible: boolean) => {
            ...
            <div class={css.default.widget_support_header}>
              <div class={css.default.widget_support_header__div}>
                <div class={css.default.widget_support_header_close__div}>
                  <button id={elementIDs.supportCloseButtonID} type="button" class={this.classes(css_esri.esri_button_tertiary, css.default.widget_support_header_close__button)} aria-label={t9n.closeButtonText} title={t9n.closeButtonText} onclick={this._closeButton_click.bind(this)} onKeyPress={this._closeButton_keypress.bind(this)} tabIndex="0">
              ...
              <div class={this.classes(css.default.widget_support_form_name__div, css.default.widget_support_display__table)}>
                <div class={css.default.widget_support_display__table_row}>
                  <div class={css.default.widget_support_display__table_cell}>
                    <label htmlFor={elementIDs.supportNameTextID} class={css.default.widget_support_form__label}>{t9n.userNameLabel}</label>
                  </div>
                  <div class={css.default.widget_support_display__table_cell}>
                ...
                <div class={css.default.widget_support_display__table_row}>
                  <div class={css.default.widget_support_display__table_cell}>
                    <label htmlFor={elementIDs.supportEmailTextID} class={css.default.widget_support_form__label}>{t9n.userEmailLabel}</label>
                  </div>
                  <div class={css.default.widget_support_display__table_cell}>
                ...
                <div class={css.default.widget_support_display__table_row}>
                  <div class={css.default.widget_support_display__table_cell}>
                    <label htmlFor={elementIDs.supportPhoneTextID} class={css.default.widget_support_form__label}>{t9n.userPhoneLabel}</label>
                  </div>
                  <div class={css.default.widget_support_display__table_cell}>
                ...
                <div class={css.default.widget_support_display__table_row}>
                  <div class={css.default.widget_support_display__table_cell}>
                    <label htmlFor={elementIDs.supportMessageTextAreaID} class={css.default.widget_support_form_textarea__label}>{t9n.userMessageLabel}</label>
                  </div>
                  <div class={css.default.widget_support_display__table_cell}>
