      ...
      <div class={css_esri.esri_widget}>
        ...
        <div id={elementIDs.addlayer_MainID} class={css.default.widget_addlayer} afterCreate={this.afterRenderActions} bind={this}>
          ...
          <div id={elementIDs.addlayer_FileTabDivID} class={this.classes(css.default.widget_addlayer_tabcontent__div)}>
            ...
            <p class={css.default.widget_addlayer_p}>{`${t9n.addFileTypeHelpText} `}<a target="_blank" rel="noopener noreferrer" href="https://doc.arcgis.com/en/arcgis-online/reference/shapefiles.htm" class={css_esri.esri_widget_anchor}>{t9n.addFileTypeHelpLinkTitle}</a></p>
            <form id={elementIDs.addlayer_FileFormID}
              encType="multipart/form-data"
              method="post">
              <div class={css.default.widget_addlayer_file_button__div}>
                <label htmlFor={elementIDs.addlayer_FileFileID} class={css.default.widget_addlayer_buttontitle__label}>{t9n.addFileButtonSectionLabel}</label>
