...
let AdvancedSearchButton = class AdvancedSearchButton extends Widget {
    ...
    render() {
        return (tsx("div", { className: css_esri.esri_widget },
            tsx("div", { id: this.id, className: this.classes(css_esri.esri_widget_button, css_esri.esri_widget), role: "button", "aria-label": buttonLabel, title: buttonLabel, tabIndex: "0", onClick: this._button_click.bind(this), onKeyPress: this._button_keypress.bind(this) },
