...
export let featureLayerArray;
let calcite_theme = calcite_dark;
let resultsTable;
let searchLayers;
let searchFields;
let _searchFieldSelectObjectsArray;
const byShapeGraphicsLayer = new GraphicsLayer();
let byShapeSketchViewModel;
const css_esri = {
...
let AdvancedSearch = class AdvancedSearch extends Widget {
    ...
    async postInitialize() {
        ...
        await processFSOArray(this.layers).then(results => {
            ...
            searchFields = this.layers.map(layer => tsx("div", { key: `${layer.id}_sf_key`, id: `${layer.id}${postFixes.layerDivID}`, className: this.classes(css.default.widget_advancedsearch_byvalue_searchfield__div) }, layer.searchfields.map(searchfield => tsx("div", { key: `${layer.id}_${searchfield.field}_key`, id: `${layer.id}_${searchfield.field}${postFixes.layerFieldDivID}`, className: css.default.widget_advancedsearch_byvalue_searchfield_fieldsnovalidation__div },
                tsx("div", { className: css.default.widget_advancedsearch_byvalue_searchfield_fields__div },
                    tsx("div", { className: css.default.widget_advancedsearch_byvalue_searchfield_fields_items__div },
                        tsx("div", { className: css.default.widget_advancedsearch_byvalue_searchfield_fields_label__div },
                            tsx("label", { htmlFor: `${layer.id}_${searchfield.field}${postFixes.layerFieldInputID}` }, searchfield.fieldlabel[_locale])),
                        tsx("div", { className: css.default.widget_advancedsearch_byvalue_fieldinput_asterix__div },
                            tsx("input", { id: `${layer.id}_${searchfield.field}${postFixes.layerFieldInputID}`, className: this.classes(css_esri.esri_input, css.default.widget_advancedsearch__select, `${searchfield.required ? css.default.widget_advancedsearch_required__input : ""}`), list: `${layer.id}_${searchfield.field}${postFixes.layerFieldDataListID}`, placeholder: searchfield.searchhint ? searchfield.searchhint : "", required: searchfield.required ? searchfield.required === true ? `"${searchfield.required}"` : "false" : "false" }),
                            ...
                            tsx("div", { id: `${layer.id}_${searchfield.field}${postFixes.layerFieldValidationAsterixDivID}`, className: this.classes(css.default.widget_advancedsearch_error__div, css.default.widget_advancedsearch_error__asterix, css.default.widget_advancedsearch_visible__none) }, "*"),
                            tsx("input", { type: "hidden", id: `${layer.id}_${searchfield.field}${postFixes.layerFieldHiddenInputID}` })))),
                tsx("div", { id: `${layer.id}_${searchfield.field}${postFixes.layerFieldValidationDivID}`, className: this.classes(css.default.widget_advancedsearch_error__div, css.default.widget_advancedsearch_visible__none) })))));
        });
    }
    render() {
        return (tsx("div", null,
            tsx("div", { id: elementIDs.advancedsearch_ModalID, className: this.classes(css.default.widget_advancedsearch_loading_modal, css.default.widget_advancedsearch_loading_modal__restored, css.default.widget_advancedsearch_visibility__hidden, calcite_theme.default["modal-background"]) },
                tsx("div", { className: this.classes(calcite_theme.default.loader, calcite_theme.default["is-active"], calcite_theme.default["padding-leader-3"], calcite_theme.default["padding-trailer-3"]) },
                    tsx("div", { className: calcite_theme.default["loader-bars"] }),
                    tsx("div", { className: calcite_theme.default["loader-text"], "aria-label": t9n.loadingText }, t9n.loadingText))),
            tsx("div", { className: this.classes(css_esri.esri_widget, css_esri.esri_component) },
                tsx("div", { id: elementIDs.advancedsearch_MainID, className: this.classes(css.default.widget_advancedsearch, css.default.widget_advancedsearch__restored, css_esri.esri_widget, css_esri.esri_component, css.default.widget_advancedsearch_transition), afterCreate: this.afterRenderActions, bind: this },
                    tsx("div", { className: css.default.widget_advancedsearch_main__div },
                        tsx("div", { id: elementIDs.advancedSearch_TitlebarDivID, className: css.default.widget_advancedsearch_titlebar__div },
                            tsx("div", { id: elementIDs.advancedSearch_TitlebarTitleDivID, className: css.default.widget_advancedsearch_titlebar_title__div },
                                tsx("span", { id: elementIDs.advancedSearch_TitlebarTitleSpanID })),
                            tsx("div", { id: elementIDs.advancedSearch_TitlebarButtonsDivID, className: css.default.widget_advancedsearch_titlebar_buttons__div },
                                tsx("button", { id: elementIDs.advancedSearch_MinimizeButtonID, type: "button", className: this.classes(css_esri.esri_button_tertiary, css.default.widget_advancedsearch_titlebar__button), "aria-label": t9n.minimizeButtonText, title: t9n.minimizeButtonText, onClick: this._minimizeButton_click.bind(this), onKeyPress: this._minimizeButton_keypress.bind(this), tabIndex: "0" },
                                    tsx("span", { id: elementIDs.advancedSearch_MinimizeSpanID, "aria-hidden": 'true', className: css_esri.esri_icon_down })),
                                tsx("button", { id: elementIDs.advancedSearch_MaximizeButtonID, type: "button", className: this.classes(css_esri.esri_button_tertiary, css.default.widget_advancedsearch_titlebar__button), "aria-label": t9n.maximizeButtonText, title: t9n.maximizeButtonText, onClick: this._maximizeButton_click.bind(this), onKeyPress: this._maximizeButton_keypress.bind(this), tabIndex: "0" },
                                    tsx("span", { id: elementIDs.advancedSearch_MaximizeSpanID, "aria-hidden": 'true', className: css_esri.esri_icon_maximize })),
                                tsx("button", { id: elementIDs.advancedSearch_CloseButtonID, type: "button", className: this.classes(css_esri.esri_button_tertiary, css.default.widget_advancedsearch_titlebar__button), "aria-label": t9n.closeButtonText, title: t9n.closeButtonText, onClick: this._closeButton_click.bind(this), onKeyPress: this._closeButton_keypress.bind(this), tabIndex: "0" },
                                    tsx("span", { id: elementIDs.advancedSearch_CloseSpanID, "aria-hidden": 'true', className: css_esri.esri_icon_close })))),
                        tsx("div", { id: elementIDs.advancedsearch_content },
                            tsx("div", { className: css.default.widget_advancedsearch_tab__div },
                                tsx("button", { id: elementIDs.advancedsearch_ByShapeTabID, className: this.classes(css.default.widget_advancedsearch_tab__button, css_esri.esri_widget_button), title: t9n.byShapeTabLabel, "aria-label": t9n.byShapeTabLabel, onClick: this._byShapeTab_click.bind(this), tabIndex: "0" }, t9n.byShapeTabLabel),
                                tsx("button", { id: elementIDs.advancedsearch_ByValueTabID, className: this.classes(css.default.widget_advancedsearch_tab__button, css_esri.esri_widget_button), title: t9n.byValueTabLabel, "aria-label": t9n.byValueTabLabel, onClick: this._byValueTab_click.bind(this), tabIndex: "0" }, t9n.byValueTabLabel),
                                tsx("button", { id: elementIDs.advancedsearch_ResultsTabID, className: this.classes(css.default.widget_advancedsearch_tab__button, css_esri.esri_widget_button), title: t9n.resultsTabLabel, "aria-label": t9n.resultsTabLabel, onClick: this._resultsTab_click.bind(this), tabIndex: "0" }, t9n.resultsTabLabel)),
                            tsx("div", { id: elementIDs.advancedsearch_MainTabcontentID, className: this.classes(css.default.widget_advancedsearch_tabcontent_main__div, css.default.widget_advancedsearch_tabcontent_main__restored) },
                                tsx("div", { id: elementIDs.advancedsearch_CommonBarID, className: css.default.widget_advancedsearch_commonbar__div },
                                    tsx("div", { className: css.default.widget_advancedsearch_commonbar_searchlayer__div },
                                        tsx("label", { htmlFor: elementIDs.advancedsearch_CommonBarSearchLayerID }, t9n.commonSearchLayerLabel),
                                        tsx("select", { id: elementIDs.advancedsearch_CommonBarSearchLayerID, className: this.classes(css_esri.esri_input, css.default.widget_advancedsearch__select), name: elementIDs.advancedsearch_CommonBarSearchLayerID, onChange: this._searchLayer_change.bind(this) }, searchLayers)),
                                    tsx("div", { className: css.default.widget_advancedsearch_commonbar_selectiontype__div },
                                        tsx("label", { htmlFor: elementIDs.advancedsearch_CommonBarSelectionTypeID }, t9n.commonSelectTypeLabel),
                                        tsx("select", { id: elementIDs.advancedsearch_CommonBarSelectionTypeID, className: this.classes(css_esri.esri_input, css.default.widget_advancedsearch__select), name: elementIDs.advancedsearch_CommonBarSelectionTypeID, onChange: this._selectionType_change.bind(this) },
                                    ...
                                    tsx("div", { className: css.default.widget_advancedsearch_commonbar_selection_buttons__div },
                                        tsx("button", { id: elementIDs.advancedSearch_CommonBarSelectionClearButtonID, type: "button", className: this.classes(css_esri.esri_widget_button, css.default.widget_advancedsearch_commonbar_selection_clear__button), "aria-label": t9n.commonSelectClearText, title: t9n.commonSelectClearText, onClick: this._selectionClearButton_click.bind(this), onKeyPress: this._selectionClearButton_keypress.bind(this), tabIndex: "0" },
                                            tsx("span", { "aria-hidden": 'true', className: css_esri.esri_icon_erase })),
                                        tsx("div", { className: css.default.widget_advancedsearch_commonbar_selection_checkbox__div },
                                            tsx("input", { id: elementIDs.advancedsearch_CommonBarSelectionZoomToFirstRecordCheckboxID, className: this.classes(css_esri.esri_input, css.default.widget_advancedsearch_checkbox__input), type: "checkbox", checked: true }),
                                            tsx("label", { htmlFor: elementIDs.advancedsearch_CommonBarSelectionZoomToFirstRecordCheckboxID, className: css.default.widget_advancedsearch_checkbox__label }, t9n.commonSelectZoomFirstRecordLabel)))),
                                tsx("div", { id: elementIDs.advancedsearch_ByShapeTabDivID, className: this.classes(css.default.widget_advancedsearch_tabcontent__div) },
                                    tsx("div", { className: css.default.widget_advancedsearch_byshape_main__div },
                                        tsx("div", { className: css_esri.esri_widget },
                                            tsx("div", { id: elementIDs.advancedSearch_ByShapeButton_rectangleID, className: this.classes(css_esri.esri_widget_button, css_esri.esri_widget, css.default.widget_advancedsearch_byshape__button), role: "button", "aria-label": t9n.byShapeRectangle, title: t9n.byShapeRectangle, onClick: (e) => { this._selectByTool_click(e, "rectangle"); }, onKeyPress: (e) => { this._selectByTool_keypress(e, "rectangle"); }, tabIndex: "0" },
                                                tsx("span", { className: this.classes(css_esri.esri_icon, css_esri.esri_icon_draw_rectangle), "aria-hidden": "true" }),
                                                tsx("span", { className: css_esri.esri_icon_font_fallback_text }, t9n.byShapeRectangle))),
                                        tsx("div", { className: css_esri.esri_widget },
                                            tsx("div", { id: elementIDs.advancedSearch_ByShapeButton_polygonID, className: this.classes(css_esri.esri_widget_button, css_esri.esri_widget, css.default.widget_advancedsearch_byshape__button), role: "button", "aria-label": t9n.byShapePolygon, title: t9n.byShapePolygon, onClick: (e) => { this._selectByTool_click(e, "polygon"); }, onKeyPress: (e) => { this._selectByTool_keypress(e, "polygon"); }, tabIndex: "0" },
                                                tsx("span", { className: this.classes(css_esri.esri_icon, css_esri.esri_icon_draw_polygon), "aria-hidden": "true" }),
                                                tsx("span", { className: css_esri.esri_icon_font_fallback_text }, t9n.byShapePolygon))),
                                        tsx("div", { className: css_esri.esri_widget },
                                            tsx("div", { id: elementIDs.advancedSearch_ByShapeButton_circleID, className: this.classes(css_esri.esri_widget_button, css_esri.esri_widget, css.default.widget_advancedsearch_byshape__button), role: "button", "aria-label": t9n.byShapeCircle, title: t9n.byShapeCircle, onClick: (e) => { this._selectByTool_click(e, "circle"); }, onKeyPress: (e) => { this._selectByTool_keypress(e, "circle"); }, tabIndex: "0" },
                                                tsx("span", { className: this.classes(css_esri.esri_icon, css_esri.esri_icon_draw_circle), "aria-hidden": "true" }),
                                                tsx("span", { className: css_esri.esri_icon_font_fallback_text }, t9n.byShapeCircle))),
                                        tsx("div", { className: css_esri.esri_widget },
                                            tsx("div", { id: elementIDs.advancedSearch_ByShapeButton_polylineID, className: this.classes(css_esri.esri_widget_button, css_esri.esri_widget, css.default.widget_advancedsearch_byshape__button), role: "button", "aria-label": t9n.byShapePolyline, title: t9n.byShapePolyline, onClick: (e) => { this._selectByTool_click(e, "polyline"); }, onKeyPress: (e) => { this._selectByTool_keypress(e, "polyline"); }, tabIndex: "0" },
                                                tsx("span", { className: this.classes(css_esri.esri_icon, css_esri.esri_icon_draw_polyline), "aria-hidden": "true" }),
                                                tsx("span", { className: css_esri.esri_icon_font_fallback_text }, t9n.byShapePolyline))),
                                        tsx("div", { className: css_esri.esri_widget },
                                            tsx("div", { id: elementIDs.advancedSearch_ByShapeButton_pointID, className: this.classes(css_esri.esri_widget_button, css_esri.esri_widget, css.default.widget_advancedsearch_byshape__button), role: "button", "aria-label": t9n.byShapePoint, title: t9n.byShapePoint, onClick: (e) => { this._selectByTool_click(e, "point"); }, onKeyPress: (e) => { this._selectByTool_keypress(e, "point"); }, tabIndex: "0" },
                                                tsx("span", { className: this.classes(css_esri.esri_icon, css_esri.esri_icon_draw_point), "aria-hidden": "true" }),
                                                tsx("span", { className: css_esri.esri_icon_font_fallback_text }, t9n.byShapePoint))))),
                                tsx("div", { id: elementIDs.advancedsearch_ByValueTabDivID, className: this.classes(css.default.widget_advancedsearch_tabcontent__div, css.default.widget_advancedsearch_visible__none) },
                                    tsx("div", { className: css.default.widget_advancedsearch_byvalue_searchfields__div }, searchFields),
                                    tsx("div", { className: css.default.widget_advancedsearch_byvalue_search_group__div },
                                        tsx("div", { className: css.default.widget_advancedsearch_byvalue_search__div },
                                            tsx("button", { id: elementIDs.advancedsearch_ByValueSearchButtonID, type: "button", className: this.classes(css_esri.esri_button), "aria-label": t9n.byValueSearchButtonLabel, title: t9n.byValueSearchButtonLabel, onClick: this._searchButton_click.bind(this), onKeyPress: this._searchButton_keypress.bind(this), tabIndex: "0" }, t9n.byValueSearchButtonLabel)),
                                        tsx("div", { className: css.default.widget_advancedsearch_checkbox__div },
                                            tsx("input", { id: elementIDs.advancedsearch_ByValueResultsExtentCheckboxID, className: this.classes(css_esri.esri_input, css.default.widget_advancedsearch_checkbox__input), type: "checkbox", checked: true }),
                                            tsx("label", { htmlFor: elementIDs.advancedsearch_ByValueResultsExtentCheckboxID, className: css.default.widget_advancedsearch_checkbox__label }, t9n.byValueLimitResultsExtentLabel))))),
                            tsx("div", { id: elementIDs.advancedsearch_ResultsTabDivID, className: this.classes(css.default.widget_advancedsearch_tabcontent__div, css.default.widget_advancedsearch_tabcontent_results__restored, css.default.widget_advancedsearch_visible__none) },
                                tsx("div", { id: elementIDs.advancedsearch_ResultsNoResultsDivID, className: css.default.widget_advancedsearch_tabcontent_resultsnoresults__div }, t9n.resultsNoResultsLabel),
                                tsx("div", { id: elementIDs.advancedsearch_ResultsDetailsDivID, className: this.classes(css.default.widget_advancedsearch_tabcontent_resultsdetails__div, css.default.widget_advancedsearch_tabcontent_resultsdetails__restored) }))))))));
    }
    //--------------------------------------------------------------------------
    //  Event Methods
    //--------------------------------------------------------------------------
    ...
    _selectionType_change() {
        const commonBarSelectionType_node = document.getElementById(elementIDs.advancedsearch_CommonBarSelectionTypeID);
    ...
    //--------------------------------------------------------------------------
    afterRenderActions() {
        const resultsDiv_node = document.getElementById(elementIDs.advancedsearch_ResultsDetailsDivID);
        const modal_node = document.getElementById(elementIDs.advancedsearch_ModalID);
        // Change the title
            ...
            await setupFeatureLayer(this.view, layer, asID).then(featureLayer => {
                ...
                if (featureLayer != null) {
                    ...
                    layer.searchfields.forEach(searchfield => {
                        const input_node = document.getElementById(`${layer.id}_${searchfield.field}${postFixes.layerFieldInputID}`);
                        // inputArray.push(input_node);
                        if (input_node) {
                            input_node.addEventListener('input', function () {
                                const inputValue = input_node.value;
                                const hiddeninput_node = document.getElementById(`${layer.id}_${searchfield.field}${postFixes.layerFieldHiddenInputID}`);
                                const options = document.querySelectorAll(`#${input_node.getAttribute('list')} option`);
                ...
                console.log(`featureLayerArray: ${featureLayerArray.map(function (fl) { return fl.get('uid'); })}`);
            });
        });
    ...
    closeWidget() {
        this.visible = false;
        const content_node = this.container;
    ...
    clearResults() {
        const resultsNoResultsDiv_node = document.getElementById(elementIDs.advancedsearch_ResultsNoResultsDivID);
        ...
        let searchLayer = "";
        const commonBarSearchLayer_node = document.getElementById(elementIDs.advancedsearch_CommonBarSearchLayerID);
