...
let AdvancedSearch = class AdvancedSearch extends Widget {
    ...
    async postInitialize() {
        ...
        reactiveUtils.watch(() => self.theme, (theme) => {
            calcite_theme = (theme === 'dark' ? calcite_dark : calcite_light);
        });
        // Dynamically create search layers.
        searchLayers = this.layers.map(layer => tsx("option", { key: `${layer.id}_key`, value: layer.id, title: layer.searchlayertitletext[_locale] }, layer.searchlayerlabel[_locale]));
        ...
        await processFSOArray(this.layers).then(results => {
            ...
            searchFields = this.layers.map(layer => tsx("div", { key: `${layer.id}_searchfields_key`, id: `${layer.id}${postFixes.layerDivID}`, class: this.classes(css.default.widget_advancedsearch_byvalue_searchfield__div) }, layer.searchfields.map(searchfield => tsx("div", { key: `${layer.id}_searchfields_field_key`, id: `${layer.id}_${searchfield.field}${postFixes.layerFieldDivID}`, class: css.default.widget_advancedsearch_byvalue_searchfield_fieldsnovalidation__div },
        ...
        return (tsx("div", null,
            tsx("div", { id: elementIDs.advancedsearch_ModalID, class: this.classes(css.default.widget_advancedsearch_loading_modal, css.default.widget_advancedsearch_loading_modal__restored, css.default.widget_advancedsearch_visibility__hidden, calcite_theme.default["modal-background"]) },
                tsx("div", { class: this.classes(calcite_theme.default.loader, calcite_theme.default["is-active"], calcite_theme.default["padding-leader-3"], calcite_theme.default["padding-trailer-3"]) },
                    ...
                    tsx("div", { class: calcite_theme.default["loader-text"], "aria-label": t9n.loadingText }, t9n.loadingText))),
                    ...
                    tsx("div", { class: css.default.widget_advancedsearch_main__div },
                        ...
                        tsx("div", { id: elementIDs.advancedsearch_content },
                            tsx("div", { class: css.default.widget_advancedsearch_tab__div },
                                tsx("button", { id: elementIDs.advancedsearch_ByShapeTabID, class: this.classes(css.default.widget_advancedsearch_tab__button, css_esri.esri_widget_button), title: t9n.byShapeTabLabel, "aria-label": t9n.byShapeTabLabel, onclick: this._byShapeTab_click.bind(this), tabIndex: "0" }, t9n.byShapeTabLabel),
                                tsx("button", { id: elementIDs.advancedsearch_ByValueTabID, class: this.classes(css.default.widget_advancedsearch_tab__button, css_esri.esri_widget_button), title: t9n.byValueTabLabel, "aria-label": t9n.byValueTabLabel, onclick: this._byValueTab_click.bind(this), tabIndex: "0" }, t9n.byValueTabLabel),
                                tsx("button", { id: elementIDs.advancedsearch_ResultsTabID, class: this.classes(css.default.widget_advancedsearch_tab__button, css_esri.esri_widget_button), title: t9n.resultsTabLabel, "aria-label": t9n.resultsTabLabel, onclick: this._resultsTab_click.bind(this), tabIndex: "0" }, t9n.resultsTabLabel)),
                                ...
                                tsx("div", { id: elementIDs.advancedsearch_CommonBarID, class: css.default.widget_advancedsearch_commonbar__div },
                                    ...
                                    tsx("div", { class: css.default.widget_advancedsearch_commonbar_selection_buttons__div },
                                        ...
                                        tsx("div", { class: css.default.widget_advancedsearch_commonbar_selection_checkbox__div },
                                            ...
                                            tsx("label", { htmlFor: elementIDs.advancedsearch_CommonBarSelectionZoomToFirstRecordCheckboxID, class: css.default.widget_advancedsearch_checkbox__label }, t9n.commonSelectZoomFirstRecordLabel)))),
                                ...
                                tsx("div", { id: elementIDs.advancedsearch_ByValueTabDivID, class: this.classes(css.default.widget_advancedsearch_tabcontent__div, css.default.widget_advancedsearch_visible__none) },
                                    ...
                                    tsx("div", { class: css.default.widget_advancedsearch_byvalue_search_group__div },
                                        ...
                                        tsx("div", { class: css.default.widget_advancedsearch_checkbox__div },
                                            ...
                                            tsx("label", { htmlFor: elementIDs.advancedsearch_ByValueResultsExtentCheckboxID, class: css.default.widget_advancedsearch_checkbox__label }, t9n.byValueLimitResultsExtentLabel))))),
    ...
    setTitle(widgetLabel = null, title = null) {
        ...
        function getStringPixelWidth(_string, referenceClassOrElement = ".esri-widget") {
            ...
            if (element && (element instanceof HTMLElement === true)) {
                ...
                const font_weight = style.getPropertyValue("font-weight") ? style.getPropertyValue("font-weight") : "";
                const font_size = style.getPropertyValue("font-size") ? style.getPropertyValue("font-size") : "";
                const font_family = style.getPropertyValue("font-family") ? style.getPropertyValue("font-family") : "";
